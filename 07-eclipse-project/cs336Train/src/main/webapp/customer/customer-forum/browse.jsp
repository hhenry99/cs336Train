...
<body>
	...
	try {
		...
		String select = "SELECT * FROM ask_question";
	...
	%>
	<div id="search-field" style="margin: 2%">
		<form method="post">
			<p>Search:</p>
			<input type="text" name="search-query"><input type="submit"
				value="submit"> <br>
		</form>
	</div>
	<%
	...
	<div class="question"
		...
		<form method="post" action="./show-post.jsp">
